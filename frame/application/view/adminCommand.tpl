                        ...
                        <!--Форма добавления события-->
                            <div class="col-md-12 formAddEvent" style="display:none;" id="addEvent2">
                                  <form id="addEventForm"  onsubmit="return false;">
                                      ...
                                      <input type="text"  placeholder="Введите новое событие" class="form-control" name="event_name" value="{$Event.event_name}"  style="width:500px;"/><br/>
                                      ...
                                      <input placeholder="Введите дату начала. Формат:дд.мм.гггг" class="form-control" name="event_period_start" type="date" value="{$Event.event_period_start}" style="margin-top:18px;width:500px;"/></br>
                                      <input class="form-control" placeholder="Введите дату окончания. Формат:дд.мм.гггг" name="event_period_end" type="date" value="{$Event.event_period_end}" style="width:500px;"/></br>
                                ...
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    ...
                                    {foreach item=stud from=$AbitArray}
                                        <tr  class="odd gradeX ">
                                            ...
                                            <td style="width:8%"><button  id="{$stud.event_id}" type="button" data-toggle="modal" data-target="#myModal"  title="Изменить событие" class="ssilka glyphicon glyphicon-pencil" ></button> | <button  value="{$stud.event_id}" title="Удалить событие" class="delE glyphicon glyphicon-remove"></button></div></td>
                                ...
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example1">
                                    ...
                                    {foreach item=stud2 from=$StudentArray}
                                        <tr class="odd gradeX ">
                                            ...
                                            <td><button  style="margin-left:37%;" id="{$stud2.student_id}" type="button"   title="Выбрать студента для начисления баллов" class="ssilkaPoint glyphicon glyphicon-plus-sign" ></button></td>
                                        </tr>
                                        {/foreach}
                                    </tbody>
                                </table>
